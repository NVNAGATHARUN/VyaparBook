-- Update create_deal_atomic to optionally accept p_user_id
-- This allows service role calls (e.g. from edge functions) to explicitly pass the user ID since auth.uid() will be null.
...
DECLARE
  ...
  v_delta numeric;
BEGIN
  -- 1. Get authenticated user ID or use provided one
